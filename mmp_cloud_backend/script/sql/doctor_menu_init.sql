...
delete from sys_menu where menu_id >=20000 and menu_id < 20200;

INSERT INTO sys_menu VALUES ('20000', '医师档案管理', '0', '100', 'doctor', NULL, '', 1, 0, 'M', '0', '0', '', 'user-md', 103, 1, sysdate(), NULL, NULL, '医师档案管理目录');

-- ----------------------------
-- 2. 创建子菜单（调整后的ID顺序，从20010开始依次向下排列）
-- ----------------------------
INSERT INTO sys_menu VALUES ('20010', '医师仪表板', '20000', '10', 'doctorDashboard', 'doctor/doctorDashboard/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorDashboard:list', 'dashboard', 103, 1, sysdate(), NULL, NULL, '医师仪表板');
INSERT INTO sys_menu VALUES ('20020', '医师信息', '20000', '20', 'doctorInfo', 'doctor/doctorInfo/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorInfo:list', 'user-circle', 103, 1, sysdate(), NULL, NULL, '医师信息管理');
INSERT INTO sys_menu VALUES ('20030', '医师证书', '20000', '30', 'doctorCertificate', 'doctor/doctorCertificate/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorCertificate:list', 'certificate', 103, 1, sysdate(), NULL, NULL, '医师证书管理');
INSERT INTO sys_menu VALUES ('20040', '医师教育', '20000', '40', 'doctorEducation', 'doctor/doctorEducation/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorEducation:list', 'graduation-cap', 103, 1, sysdate(), NULL, NULL, '医师教育经历');
INSERT INTO sys_menu VALUES ('20050', '医师工作经验', '20000', '50', 'doctorWorkExperience', 'doctor/doctorWorkExperience/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorWorkExperience:list', 'briefcase', 103, 1, sysdate(), NULL, NULL, '医师工作经验');
INSERT INTO sys_menu VALUES ('20060', '医师培训', '20000', '60', 'doctorTraining', 'doctor/doctorTraining/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorTraining:list', 'chalkboard-teacher', 103, 1, sysdate(), NULL, NULL, '医师培训记录');
INSERT INTO sys_menu VALUES ('20070', '医师学术职称', '20000', '70', 'doctorAcademicPosition', 'doctor/doctorAcademicPosition/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorAcademicPosition:list', 'user-tie', 103, 1, sysdate(), NULL, NULL, '医师学术职称');
INSERT INTO sys_menu VALUES ('20080', '医师专业评级', '20000', '80', 'doctorProfessionalRating', 'doctor/doctorProfessionalRating/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorProfessionalRating:list', 'star', 103, 1, sysdate(), NULL, NULL, '医师专业评级');
INSERT INTO sys_menu VALUES ('20090', '医师资格目录', '20000', '90', 'doctorQualificationCatalog', 'doctor/doctorQualificationCatalog/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorQualificationCatalog:list', 'list', 103, 1, sysdate(), NULL, NULL, '医师资格目录');
INSERT INTO sys_menu VALUES ('20100', '医师荣誉', '20000', '100', 'doctorHonor', 'doctor/doctorHonor/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorHonor:list', 'trophy', 103, 1, sysdate(), NULL, NULL, '医师荣誉记录');
INSERT INTO sys_menu VALUES ('20110', '医师发表物', '20000', '110', 'doctorPublication', 'doctor/doctorPublication/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorPublication:list', 'book', 103, 1, sysdate(), NULL, NULL, '医师发表物');
INSERT INTO sys_menu VALUES ('20120', '医师研究项目', '20000', '120', 'doctorResearchProject', 'doctor/doctorResearchProject/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorResearchProject:list', 'flask', 103, 1, sysdate(), NULL, NULL, '医师研究项目');
INSERT INTO sys_menu VALUES ('20130', '医师能力评估', '20000', '130', 'doctorAbilityAssessment', 'doctor/doctorAbilityAssessment/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorAbilityAssessment:list', 'chart-line', 103, 1, sysdate(), NULL, NULL, '医师能力评估');
INSERT INTO sys_menu VALUES ('20140', '医师伦理评价', '20000', '140', 'doctorEthicsEvaluation', 'doctor/doctorEthicsEvaluation/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorEthicsEvaluation:list', 'balance-scale', 103, 1, sysdate(), NULL, NULL, '医师伦理评价');
INSERT INTO sys_menu VALUES ('20150', '医师不良记录', '20000', '150', 'doctorAdverseRecord', 'doctor/doctorAdverseRecord/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorAdverseRecord:list', 'exclamation-triangle', 103, 1, sysdate(), NULL, NULL, '医师不良记录');
INSERT INTO sys_menu VALUES ('20160', '医师电子注册', '20000', '160', 'doctorElectronicRegistration', 'doctor/doctorElectronicRegistration/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorElectronicRegistration:list', 'id-card', 103, 1, sysdate(), NULL, NULL, '医师电子注册');
INSERT INTO sys_menu VALUES ('20170', '医师保险代码', '20000', '170', 'doctorInsuranceCode', 'doctor/doctorInsuranceCode/index', '', 1, 0, 'C', '0', '0', 'doctor:doctorInsuranceCode:list', 'shield-alt', 103, 1, sysdate(), NULL, NULL, '医师保险代码');

-- ----------------------------
-- 3. 创建医师相关角色
-- ----------------------------
delete from sys_role where role_id in ('5','6','7','8','9');

INSERT INTO sys_role VALUES('5', '000000', '医生护士', 'doctor_nurse', 5, 5, 1, 1, '0', '0', 103, 1, sysdate(), null, null, '医生护士角色，仅能查看本人数据');
INSERT INTO sys_role VALUES('6', '000000', '科室主任', 'dept_director', 6, 3, 1, 1, '0', '0', 103, 1, sysdate(), null, null, '科室主任角色，能查看本部门数据');
INSERT INTO sys_role VALUES('7', '000000', '医务处', 'medical_affairs', 7, 1, 1, 1, '0', '0', 103, 1, sysdate(), null, null, '医务处角色，能查看全部数据');
INSERT INTO sys_role VALUES('8', '000000', '医务处主任', 'medical_director', 8, 1, 1, 1, '0', '0', 103, 1, sysdate(), null, null, '医务处主任角色，能查看全部数据');
INSERT INTO sys_role VALUES('9', '000000', '医院管理员', 'hospital_admin', 9, 0, 1, 1, '0', '0', 103, 1, sysdate(), null, null, '医院管理员角色，能查看全部数据和管理医师档案');

-- ----------------------------
-- 4. 定义按钮权限（每个菜单都有增删改查导出导入权限）
-- ----------------------------
-- 医师仪表板按钮
INSERT INTO sys_menu VALUES ('20011', '医师仪表板查询', '20010', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorDashboard:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20012', '医师仪表板新增', '20010', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorDashboard:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20013', '医师仪表板修改', '20010', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorDashboard:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20014', '医师仪表板删除', '20010', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorDashboard:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20015', '医师仪表板导入', '20010', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorDashboard:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20016', '医师仪表板导出', '20010', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorDashboard:export', '#', 103, 1, sysdate(), NULL, NULL, '');

-- 医师信息按钮
INSERT INTO sys_menu VALUES ('20021', '医师信息查询', '20020', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorInfo:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20022', '医师信息新增', '20020', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorInfo:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20023', '医师信息修改', '20020', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorInfo:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20024', '医师信息删除', '20020', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorInfo:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20025', '医师信息导入', '20020', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorInfo:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20026', '医师信息导出', '20020', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorInfo:export', '#', 103, 1, sysdate(), NULL, NULL, '');

-- 医师证书按钮
INSERT INTO sys_menu VALUES ('20031', '医师证书查询', '20030', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorCertificate:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20032', '医师证书新增', '20030', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorCertificate:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20033', '医师证书修改', '20030', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorCertificate:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20034', '医师证书删除', '20030', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorCertificate:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20035', '医师证书导入', '20030', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorCertificate:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20036', '医师证书导出', '20030', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorCertificate:export', '#', 103, 1, sysdate(), NULL, NULL, '');

-- 医师教育按钮
INSERT INTO sys_menu VALUES ('20041', '医师教育查询', '20040', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorEducation:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20042', '医师教育新增', '20040', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorEducation:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20043', '医师教育修改', '20040', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorEducation:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20044', '医师教育删除', '20040', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorEducation:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20045', '医师教育导入', '20040', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorEducation:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20046', '医师教育导出', '20040', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorEducation:export', '#', 103, 1, sysdate(), NULL, NULL, '');

-- 医师工作经验按钮
INSERT INTO sys_menu VALUES ('20051', '医师工作经验查询', '20050', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorWorkExperience:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20052', '医师工作经验新增', '20050', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorWorkExperience:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20053', '医师工作经验修改', '20050', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorWorkExperience:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20054', '医师工作经验删除', '20050', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorWorkExperience:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20055', '医师工作经验导入', '20050', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorWorkExperience:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20056', '医师工作经验导出', '20050', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorWorkExperience:export', '#', 103, 1, sysdate(), NULL, NULL, '');

-- 医师培训按钮
INSERT INTO sys_menu VALUES ('20061', '医师培训查询', '20060', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorTraining:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20062', '医师培训新增', '20060', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorTraining:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20063', '医师培训修改', '20060', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorTraining:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20064', '医师培训删除', '20060', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorTraining:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20065', '医师培训导入', '20060', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorTraining:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20066', '医师培训导出', '20060', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorTraining:export', '#', 103, 1, sysdate(), NULL, NULL, '');

-- 医师学术职称按钮
INSERT INTO sys_menu VALUES ('20071', '医师学术职称查询', '20070', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAcademicPosition:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20072', '医师学术职称新增', '20070', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAcademicPosition:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20073', '医师学术职称修改', '20070', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAcademicPosition:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20074', '医师学术职称删除', '20070', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAcademicPosition:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20075', '医师学术职称导入', '20070', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAcademicPosition:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20076', '医师学术职称导出', '20070', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAcademicPosition:export', '#', 103, 1, sysdate(), NULL, NULL, '');

-- 医师专业评级按钮
INSERT INTO sys_menu VALUES ('20081', '医师专业评级查询', '20080', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorProfessionalRating:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20082', '医师专业评级新增', '20080', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorProfessionalRating:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20083', '医师专业评级修改', '20080', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorProfessionalRating:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20084', '医师专业评级删除', '20080', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorProfessionalRating:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20085', '医师专业评级导入', '20080', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorProfessionalRating:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20086', '医师专业评级导出', '20080', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorProfessionalRating:export', '#', 103, 1, sysdate(), NULL, NULL, '');

-- 医师资格目录按钮
INSERT INTO sys_menu VALUES ('20091', '医师资格目录查询', '20090', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorQualificationCatalog:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20092', '医师资格目录新增', '20090', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorQualificationCatalog:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20093', '医师资格目录修改', '20090', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorQualificationCatalog:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20094', '医师资格目录删除', '20090', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorQualificationCatalog:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20095', '医师资格目录导入', '20090', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorQualificationCatalog:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20096', '医师资格目录导出', '20090', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorQualificationCatalog:export', '#', 103, 1, sysdate(), NULL, NULL, '');

-- 医师荣誉按钮
INSERT INTO sys_menu VALUES ('20101', '医师荣誉查询', '20100', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorHonor:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20102', '医师荣誉新增', '20100', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorHonor:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20103', '医师荣誉修改', '20100', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorHonor:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20104', '医师荣誉删除', '20100', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorHonor:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20105', '医师荣誉导入', '20100', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorHonor:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20106', '医师荣誉导出', '20100', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorHonor:export', '#', 103, 1, sysdate(), NULL, NULL, '');

-- 医师发表物按钮
INSERT INTO sys_menu VALUES ('20111', '医师发表物查询', '20110', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorPublication:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20112', '医师发表物新增', '20110', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorPublication:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20113', '医师发表物修改', '20110', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorPublication:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20114', '医师发表物删除', '20110', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorPublication:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20115', '医师发表物导入', '20110', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorPublication:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20116', '医师发表物导出', '20110', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorPublication:export', '#', 103, 1, sysdate(), NULL, NULL, '');

-- 医师研究项目按钮
INSERT INTO sys_menu VALUES ('20121', '医师研究项目查询', '20120', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorResearchProject:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20122', '医师研究项目新增', '20120', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorResearchProject:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20123', '医师研究项目修改', '20120', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorResearchProject:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20124', '医师研究项目删除', '20120', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorResearchProject:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20125', '医师研究项目导入', '20120', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorResearchProject:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20126', '医师研究项目导出', '20120', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorResearchProject:export', '#', 103, 1, sysdate(), NULL, NULL, '');

-- 医师能力评估按钮
INSERT INTO sys_menu VALUES ('20131', '医师能力评估查询', '20130', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAbilityAssessment:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20132', '医师能力评估新增', '20130', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAbilityAssessment:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20133', '医师能力评估修改', '20130', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAbilityAssessment:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20134', '医师能力评估删除', '20130', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAbilityAssessment:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20135', '医师能力评估导入', '20130', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAbilityAssessment:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20136', '医师能力评估导出', '20130', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAbilityAssessment:export', '#', 103, 1, sysdate(), NULL, NULL, '');

-- 医师伦理评价按钮
INSERT INTO sys_menu VALUES ('20141', '医师伦理评价查询', '20140', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorEthicsEvaluation:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20142', '医师伦理评价新增', '20140', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorEthicsEvaluation:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20143', '医师伦理评价修改', '20140', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorEthicsEvaluation:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20144', '医师伦理评价删除', '20140', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorEthicsEvaluation:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20145', '医师伦理评价导入', '20140', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorEthicsEvaluation:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20146', '医师伦理评价导出', '20140', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorEthicsEvaluation:export', '#', 103, 1, sysdate(), NULL, NULL, '');

-- 医师不良记录按钮
INSERT INTO sys_menu VALUES ('20151', '医师不良记录查询', '20150', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAdverseRecord:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20152', '医师不良记录新增', '20150', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAdverseRecord:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20153', '医师不良记录修改', '20150', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAdverseRecord:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20154', '医师不良记录删除', '20150', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAdverseRecord:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20155', '医师不良记录导入', '20150', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAdverseRecord:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20156', '医师不良记录导出', '20150', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorAdverseRecord:export', '#', 103, 1, sysdate(), NULL, NULL, '');

-- 医师电子注册按钮
INSERT INTO sys_menu VALUES ('20161', '医师电子注册查询', '20160', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorElectronicRegistration:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20162', '医师电子注册新增', '20160', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorElectronicRegistration:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20163', '医师电子注册修改', '20160', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorElectronicRegistration:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20164', '医师电子注册删除', '20160', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorElectronicRegistration:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20165', '医师电子注册导入', '20160', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorElectronicRegistration:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20166', '医师电子注册导出', '20160', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorElectronicRegistration:export', '#', 103, 1, sysdate(), NULL, NULL, '');

-- 医师保险代码按钮
INSERT INTO sys_menu VALUES ('20171', '医师保险代码查询', '20170', '1', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorInsuranceCode:query', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20172', '医师保险代码新增', '20170', '2', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorInsuranceCode:add', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20173', '医师保险代码修改', '20170', '3', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorInsuranceCode:edit', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20174', '医师保险代码删除', '20170', '4', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorInsuranceCode:remove', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20175', '医师保险代码导入', '20170', '5', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorInsuranceCode:import', '#', 103, 1, sysdate(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('20176', '医师保险代码导出', '20170', '6', '#', '', '', 1, 0, 'F', '0', '0', 'doctor:doctorInsuranceCode:export', '#', 103, 1, sysdate(), NULL, NULL, '');
...
delete from sys_role_menu where menu_id >=20000 and menu_id < 20200;
