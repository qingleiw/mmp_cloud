...
import org.dromara.cdi.mmp.complaindispute.domain.vo.MmpComplaintDisputeVo;
import org.dromara.cdi.mmp.complaindispute.domain.bo.MmpComplaintDisputeBo;
import org.dromara.cdi.mmp.complaindispute.service.IMmpComplaintDisputeService;
...
public class MmpComplaintDisputeController extends BaseController {
     ...
     * 查询投诉纠纷主列表
     */
    @SaCheckPermission("complaindispute:complaintDispute:list")
    @GetMapping("/list")
     ...
     * 导出投诉纠纷主列表
     */
    @SaCheckPermission("complaindispute:complaintDispute:export")
     ...
     * @param id 主键
     */
    @SaCheckPermission("complaindispute:complaintDispute:query")
    @GetMapping("/{id}")
     ...
     * 新增投诉纠纷主
     */
    @SaCheckPermission("complaindispute:complaintDispute:add")
     ...
     * 修改投诉纠纷主
     */
    @SaCheckPermission("complaindispute:complaintDispute:edit")
     ...
     * @param ids 主键串
     */
    @SaCheckPermission("complaindispute:complaintDispute:remove")
