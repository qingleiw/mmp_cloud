...
/**
 * B17-2 微生物检验记录业务对象 mmp_natdss_b17-2_lab_microbiological_info
 *
 * @author LionLi
 * @date 2026-01-15
 */
...
@AutoMapper(target = MmpNatdssB17-2LabMicrobiologicalInfo.class, reverseConvertGenerate = false)
public class MmpNatdssB17-2LabMicrobiologicalInfoBo extends BaseEntity {
