...
/**
 * B05-1 入院记录业务对象 mmp_natdss_b05_1_emr_admission
 *
 * @author LionLi
 * @date 2026-01-15
 */
...
@AutoMapper(target = MmpNatdssB051EmrAdmission.class, reverseConvertGenerate = false)
public class MmpNatdssB051EmrAdmissionBo extends BaseEntity {
     ...
     * 入院记录流水号
     */
    @NotBlank(message = "入院记录流水号不能为空", groups = { AddGroup.class, EditGroup.class })
