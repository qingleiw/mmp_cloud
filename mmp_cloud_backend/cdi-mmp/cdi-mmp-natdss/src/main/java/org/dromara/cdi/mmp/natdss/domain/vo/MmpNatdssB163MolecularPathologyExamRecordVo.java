...
/**
 * B163 分子病理检测记录视图对象 mmp_natdss_b16-3_molecular_pathology_exam_record
 *
 * @author LionLi
 * @date 2026-01-15
 */
...
@AutoMapper(target = MmpNatdssB163MolecularPathologyExamRecord.class)
public class MmpNatdssB163MolecularPathologyExamRecordVo implements Serializable {
