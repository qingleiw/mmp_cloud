...
/**
 * B16-1 常规检查记录业务对象 mmp_natdss_b16_1_exam_info
 *
 * @author LionLi
 * @date 2026-01-15
 */
...
@AutoMapper(target = MmpNatdssB161ExamInfo.class, reverseConvertGenerate = false)
public class MmpNatdssB161ExamInfoBo extends BaseEntity {
     ...
     * 检查流水号
     */
    @NotBlank(message = "检查流水号不能为空", groups = { AddGroup.class, EditGroup.class })
