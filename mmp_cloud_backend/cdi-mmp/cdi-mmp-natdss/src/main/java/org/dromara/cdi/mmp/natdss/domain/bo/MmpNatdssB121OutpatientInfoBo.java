...
/**
 * B12-1 门诊患者信息业务对象 mmp_natdss_b12_1_outpatient_info
 *
 * @author LionLi
 * @date 2026-01-15
 */
...
@AutoMapper(target = MmpNatdssB121OutpatientInfo.class, reverseConvertGenerate = false)
public class MmpNatdssB121OutpatientInfoBo extends BaseEntity {
