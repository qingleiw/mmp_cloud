...
/**
 * B02-2 患者药物不良反应记录业务对象 mmp_natdss_b02_2_adr_info
 *
 * @author LionLi
 * @date 2026-01-15
 */
...
@AutoMapper(target = MmpNatdssB022AdrInfo.class, reverseConvertGenerate = false)
public class MmpNatdssB022AdrInfoBo extends BaseEntity {
     ...
     * 药品不良反应流水号
     */
    @NotBlank(message = "药品不良反应流水号不能为空", groups = { AddGroup.class, EditGroup.class })
