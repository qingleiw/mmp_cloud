...
/**
 * B16-2 病理检查记录视图对象 mmp_natdss_b16-2_pathological_exam_record
 *
 * @author LionLi
 * @date 2026-01-15
 */
...
@AutoMapper(target = MmpNatdssB16-2PathologicalExamRecord.class)
public class MmpNatdssB16-2PathologicalExamRecordVo implements Serializable {
