...
/**
 * B04病历首页-核心信息-非中医院（基础+诊断+主要手术）业务对象 mmp_natdss_b04_medical_record_front_sheet_non_tcm
 *
 * @author LionLi
 * @date 2026-01-18
 */
...
@AutoMapper(target = MmpNatdssB04MedicalRecordFrontSheetNonTcm.class, reverseConvertGenerate = false)
public class MmpNatdssB04MedicalRecordFrontSheetNonTcmBo extends BaseEntity {
     ...
     * 医疗机构名称
     */
    @NotBlank(message = "医疗机构名称不能为空", groups = { AddGroup.class, EditGroup.class })
    private String a02;

    /**
     * 病案号
     */
    @NotBlank(message = "病案号不能为空", groups = { AddGroup.class, EditGroup.class })
    private String a48;

    /**
     * 住院次数
     */
    @NotNull(message = "住院次数不能为空", groups = { AddGroup.class, EditGroup.class })
    private Long a49;

    /**
     * 入院时间
     */
    @NotNull(message = "入院时间不能为空", groups = { AddGroup.class, EditGroup.class })
    private Date b12;

    /**
     * 出院时间
     */
    @NotNull(message = "出院时间不能为空", groups = { AddGroup.class, EditGroup.class })
    private Date b15;

    /**
     * 健康卡号
     */
    @NotBlank(message = "健康卡号不能为空", groups = { AddGroup.class, EditGroup.class })
    private String a47;

    /**
     * 医疗付费方式
     */
    @NotBlank(message = "医疗付费方式不能为空", groups = { AddGroup.class, EditGroup.class })
    private String a46c;
     ...
     * 年龄(岁)
     */
    @NotNull(message = "年龄(岁)不能为空", groups = { AddGroup.class, EditGroup.class })
    private Long a14;
     ...
     * 出生地址
     */
    @NotBlank(message = "出生地址不能为空", groups = { AddGroup.class, EditGroup.class })
    private String a22;

    /**
     * 籍贯省(自治区、直辖市)
     */
    @NotBlank(message = "籍贯省(自治区、直辖市)不能为空", groups = { AddGroup.class, EditGroup.class })
    private String a23c;

    /**
     * 户口地址
     */
    @NotBlank(message = "户口地址不能为空", groups = { AddGroup.class, EditGroup.class })
    private String a24;

    /**
     * 户口地址邮政编码
     */
    @NotBlank(message = "户口地址邮政编码不能为空", groups = { AddGroup.class, EditGroup.class })
    private String a25c;

    /**
     * 现住址
     */
    @NotBlank(message = "现住址不能为空", groups = { AddGroup.class, EditGroup.class })
    private String a26;

    /**
     * 现住址电话
     */
    @NotBlank(message = "现住址电话不能为空", groups = { AddGroup.class, EditGroup.class })
    private String a27;

    /**
     * 现住址邮政编码
     */
    @NotBlank(message = "现住址邮政编码不能为空", groups = { AddGroup.class, EditGroup.class })
    private String a28c;

    /**
     * 工作单位及地址
     */
    @NotBlank(message = "工作单位及地址不能为空", groups = { AddGroup.class, EditGroup.class })
    private String a29;

    /**
     * 工作单位电话
     */
    @NotBlank(message = "工作单位电话不能为空", groups = { AddGroup.class, EditGroup.class })
    private String a30;

    /**
     * 工作单位邮政编码
     */
    @NotBlank(message = "工作单位邮政编码不能为空", groups = { AddGroup.class, EditGroup.class })
    private String a31c;
     ...
     * 联系人关系
     */
    @NotBlank(message = "联系人关系不能为空", groups = { AddGroup.class, EditGroup.class })
    private String a33c;

    /**
     * 联系人地址
     */
    @NotBlank(message = "联系人地址不能为空", groups = { AddGroup.class, EditGroup.class })
    private String a34;
     ...
     * 入院途径
     */
    @NotBlank(message = "入院途径不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b11c;

    /**
     * 入院科别
     */
    @NotBlank(message = "入院科别不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b13c;

    /**
     * 入院病房
     */
    @NotBlank(message = "入院病房不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b14;

    /**
     * 转科科别
     */
    @NotBlank(message = "转科科别不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b21c;

    /**
     * 出院科别
     */
    @NotBlank(message = "出院科别不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b16c;

    /**
     * 出院病房
     */
    @NotBlank(message = "出院病房不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b17;

    /**
     * 实际住院(天)
     */
    @NotNull(message = "实际住院(天)不能为空", groups = { AddGroup.class, EditGroup.class })
    private Long b20;

    /**
     * 门(急)诊诊断编码
     */
    @NotBlank(message = "门(急)诊诊断编码不能为空", groups = { AddGroup.class, EditGroup.class })
    private String c01c;

    /**
     * 门(急)诊诊断名称
     */
    @NotBlank(message = "门(急)诊诊断名称不能为空", groups = { AddGroup.class, EditGroup.class })
    private String c02n;

    /**
     * 出院主要诊断编码
     */
    @NotBlank(message = "出院主要诊断编码不能为空", groups = { AddGroup.class, EditGroup.class })
    private String c03c;

    /**
     * 出院主要诊断名称
     */
    @NotBlank(message = "出院主要诊断名称不能为空", groups = { AddGroup.class, EditGroup.class })
    private String c04n;

    /**
     * 出院主要诊断入院病情
     */
    @NotBlank(message = "出院主要诊断入院病情不能为空", groups = { AddGroup.class, EditGroup.class })
    private String c05c;
     ...
     * 有无药物过敏
     */
    @NotBlank(message = "有无药物过敏不能为空", groups = { AddGroup.class, EditGroup.class })
    private String c24c;
     ...
     * ABO血型
     */
    @NotBlank(message = "ABO血型不能为空", groups = { AddGroup.class, EditGroup.class })
    private String c26c;

    /**
     * Rh血型
     */
    @NotBlank(message = "Rh血型不能为空", groups = { AddGroup.class, EditGroup.class })
    private String c27c;

    /**
     * 死亡患者尸检
     */
    @NotBlank(message = "死亡患者尸检不能为空", groups = { AddGroup.class, EditGroup.class })
    private String c34c;

    /**
     * 科主任
     */
    @NotBlank(message = "科主任不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b22;

    /**
     * 主(副主)任医师
     */
    @NotBlank(message = "主(副主)任医师不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b23;

    /**
     * 主治医师
     */
    @NotBlank(message = "主治医师不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b24;

    /**
     * 住院医师
     */
    @NotBlank(message = "住院医师不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b25;

    /**
     * 责任护士
     */
    @NotBlank(message = "责任护士不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b26;

    /**
     * 进修医师
     */
    @NotBlank(message = "进修医师不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b27;

    /**
     * 实习医师
     */
    @NotBlank(message = "实习医师不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b28;

    /**
     * 编码员
     */
    @NotBlank(message = "编码员不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b29;

    /**
     * 病案质量
     */
    @NotBlank(message = "病案质量不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b30c;

    /**
     * 质控医师
     */
    @NotBlank(message = "质控医师不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b31;

    /**
     * 质控护师
     */
    @NotBlank(message = "质控护师不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b32;

    /**
     * 质控日期
     */
    @NotNull(message = "质控日期不能为空", groups = { AddGroup.class, EditGroup.class })
    private Date b33;
     ...
     * 是否有出院31日内再住院计划
     */
    @NotNull(message = "是否有出院31日内再住院计划不能为空", groups = { AddGroup.class, EditGroup.class })
    private Long b36c;
     ...
     * 离院方式
     */
    @NotBlank(message = "离院方式不能为空", groups = { AddGroup.class, EditGroup.class })
    private String b34c;
