...
/**
 * B162 病理检查记录业务对象 mmp_natdss_b16-2_pathological_exam_record
 *
 * @author LionLi
 * @date 2026-01-15
 */
...
@AutoMapper(target = MmpNatdssB162PathologicalExamRecord.class, reverseConvertGenerate = false)
public class MmpNatdssB162PathologicalExamRecordBo extends BaseEntity {
