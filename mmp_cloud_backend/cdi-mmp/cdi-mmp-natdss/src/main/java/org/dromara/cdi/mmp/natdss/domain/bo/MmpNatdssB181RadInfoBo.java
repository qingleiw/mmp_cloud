...
/**
 * B18-1 临床放疗记录业务对象 mmp_natdss_b18_1_rad_info
 *
 * @author LionLi
 * @date 2026-01-15
 */
...
@AutoMapper(target = MmpNatdssB181RadInfo.class, reverseConvertGenerate = false)
public class MmpNatdssB181RadInfoBo extends BaseEntity {
     ...
     * 放疗流水号
     */
    @NotBlank(message = "放疗流水号不能为空", groups = { AddGroup.class, EditGroup.class })
