...
/**
 * B04非中医院-补充信息（其他手术+费用+扩展信息）对象 mmp_natdss_b04_medical_record_front_sheet_non_tcm_supplement
 *
 * @author LionLi
 * @date 2026-01-18
 */
...
@TableName("mmp_natdss_b04_medical_record_front_sheet_non_tcm_supplement")
public class MmpNatdssB04MedicalRecordFrontSheetNonTcmSupplement extends BaseEntity {
