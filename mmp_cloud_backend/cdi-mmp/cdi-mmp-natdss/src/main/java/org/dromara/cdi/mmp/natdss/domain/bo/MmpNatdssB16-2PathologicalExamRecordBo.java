...
/**
 * B16-2 病理检查记录业务对象 mmp_natdss_b16-2_pathological_exam_record
 *
 * @author LionLi
 * @date 2026-01-15
 */
...
@AutoMapper(target = MmpNatdssB16-2PathologicalExamRecord.class, reverseConvertGenerate = false)
public class MmpNatdssB16-2PathologicalExamRecordBo extends BaseEntity {
     ...
     * 病理检查流水号
     */
    @NotBlank(message = "病理检查流水号不能为空", groups = { AddGroup.class, EditGroup.class })
