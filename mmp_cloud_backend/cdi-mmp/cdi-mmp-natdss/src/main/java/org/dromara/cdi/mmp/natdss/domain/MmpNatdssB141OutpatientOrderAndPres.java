...
/**
 * B14-1 门诊医嘱处方记录对象 mmp_natdss_b14_1_outpatient_order_and_pres
 *
 * @author LionLi
 * @date 2026-01-15
 */
...
@TableName("mmp_natdss_b14_1_outpatient_order_and_pres")
public class MmpNatdssB141OutpatientOrderAndPres extends BaseEntity {
