...
import org.dromara.cdi.mmp.complaintdispute.domain.vo.MmpComplaintHandlingVo;
import org.dromara.cdi.mmp.complaintdispute.domain.bo.MmpComplaintHandlingBo;
import org.dromara.cdi.mmp.complaintdispute.service.IMmpComplaintHandlingService;
...
public class MmpComplaintHandlingController extends BaseController {
     ...
     * 查询投诉处理记录列表
     */
    @SaCheckPermission("complaintdispute:complaintHandling:list")
    @GetMapping("/list")
     ...
     * 导出投诉处理记录列表
     */
    @SaCheckPermission("complaintdispute:complaintHandling:export")
     ...
     * @param id 主键
     */
    @SaCheckPermission("complaintdispute:complaintHandling:query")
    @GetMapping("/{id}")
     ...
     * 新增投诉处理记录
     */
    @SaCheckPermission("complaintdispute:complaintHandling:add")
     ...
     * 修改投诉处理记录
     */
    @SaCheckPermission("complaintdispute:complaintHandling:edit")
     ...
     * @param ids 主键串
     */
    @SaCheckPermission("complaintdispute:complaintHandling:remove")
