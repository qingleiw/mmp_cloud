...
public class MmpComplaintInvestigationController extends BaseController {
     ...
     * 查询投诉调查记录列表
     */
    @SaCheckPermission("complaintdispute:complaintInvestigation:list")
    @GetMapping("/list")
     ...
     * 导出投诉调查记录列表
     */
    @SaCheckPermission("complaintdispute:complaintInvestigation:export")
     ...
     * @param id 主键
     */
    @SaCheckPermission("complaintdispute:complaintInvestigation:query")
    @GetMapping("/{id}")
     ...
     * 新增投诉调查记录
     */
    @SaCheckPermission("complaintdispute:complaintInvestigation:add")
     ...
     * 修改投诉调查记录
     */
    @SaCheckPermission("complaintdispute:complaintInvestigation:edit")
     ...
     * @param ids 主键串
     */
    @SaCheckPermission("complaintdispute:complaintInvestigation:remove")
