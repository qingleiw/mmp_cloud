...
@RestController
@RequestMapping("/newTechnologyProjectMapping")
public class MmpNewTechnologyProjectMappingController extends BaseController {
     ...
     * 查询新技术项目对码列表
     */
    @SaCheckPermission("ntp:newTechnologyProjectMapping:list")
    @GetMapping("/list")
     ...
     * 导出新技术项目对码列表
     */
    @SaCheckPermission("ntp:newTechnologyProjectMapping:export")
     ...
     * @param id 主键
     */
    @SaCheckPermission("ntp:newTechnologyProjectMapping:query")
    @GetMapping("/{id}")
     ...
     * 新增新技术项目对码
     */
    @SaCheckPermission("ntp:newTechnologyProjectMapping:add")
     ...
     * 修改新技术项目对码
     */
    @SaCheckPermission("ntp:newTechnologyProjectMapping:edit")
     ...
     * @param ids 主键串
     */
    @SaCheckPermission("ntp:newTechnologyProjectMapping:remove")
