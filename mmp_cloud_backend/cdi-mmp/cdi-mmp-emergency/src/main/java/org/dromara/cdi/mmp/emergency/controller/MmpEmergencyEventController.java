...
@RestController
@RequestMapping("/system/emergencyEvent")
public class MmpEmergencyEventController extends BaseController {
     ...
     * 查询突发事件记录列表
     */
    @SaCheckPermission("system:emergencyEvent:list")
    @GetMapping("/list")
     ...
     * 导出突发事件记录列表
     */
    @SaCheckPermission("system:emergencyEvent:export")
     ...
     * @param id 主键
     */
    @SaCheckPermission("system:emergencyEvent:query")
    @GetMapping("/{id}")
     ...
     * 新增突发事件记录
     */
    @SaCheckPermission("system:emergencyEvent:add")
     ...
     * 修改突发事件记录
     */
    @SaCheckPermission("system:emergencyEvent:edit")
     ...
     * @param ids 主键串
     */
    @SaCheckPermission("system:emergencyEvent:remove")
