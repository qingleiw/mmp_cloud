...
import { ComplaintDisputeVO, ComplaintDisputeForm, ComplaintDisputeQuery } from '@/api/system/complaintDispute/types';
...
export const listComplaintDispute = (query?: ComplaintDisputeQuery): AxiosPromise<ComplaintDisputeVO[]> => {
  return request({
    url: '/system/complaintDispute/list',
    method: 'get',
    params: query
  });
};
...
export const getComplaintDispute = (id: string | number): AxiosPromise<ComplaintDisputeVO> => {
  return request({
    url: '/system/complaintDispute/' + id,
    method: 'get'
  });
};
