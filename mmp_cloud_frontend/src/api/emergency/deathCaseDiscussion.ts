...
export function listDeathCase(query: any) {
  return request({
    url: '/emergency/death-case-discussion/list',
    method: 'get',
    params: query
  });
}
...
export function getDeathCase(id: any) {
  return request({
    url: '/emergency/death-case-discussion/' + id,
    method: 'get'
  });
}
...
export function addDeathCase(data: any) {
  return request({
    url: '/emergency/death-case-discussion',
    method: 'post',
    data: data
  });
}
...
export function exportDeathCase(query: any) {
  return request({
    url: '/emergency/death-case-discussion/export',
    method: 'post',
    params: query
  });
}
