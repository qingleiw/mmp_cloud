...
import { listDoctorCertificate } from '@/api/doctor/doctorCertificate';
import { listDoctorAbilityAssessment } from '@/api/doctor/doctorAbilityAssessment';
import { listDoctorElectronicRegistration } from '@/api/doctor/doctorElectronicRegistration';
import { listDoctorInsuranceCode } from '@/api/doctor/doctorInsuranceCode';
