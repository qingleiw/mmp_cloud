      ...
      <template #header>
        <div class="table-header">
          ...
          <div class="table-actions">
            <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['doctor:doctorEthicsEvaluation:add']" size="small">新增</el-button>
            <el-button
              type="success"
              plain
              icon="Edit"
            ...
            <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['doctor:doctorEthicsEvaluation:export']" size="small">导出</el-button>
            <el-button type="primary" plain icon="Upload" @click="handleImport" v-hasPermi="['doctor:doctorEthicsEvaluation:import']" size="small">导入</el-button>
...
const handleQuery = () => {
  // 处理daterange字段
  if (queryParams.evaluationDate && Array.isArray(queryParams.evaluationDate)) {
    queryParams.evaluationDateStart = queryParams.evaluationDate[0];
    queryParams.evaluationDateEnd = queryParams.evaluationDate[1];
  } else {
    queryParams.evaluationDateStart = undefined;
    queryParams.evaluationDateEnd = undefined;
  }
