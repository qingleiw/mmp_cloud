<template>
  <div class="app-container">
    ...
    <el-card shadow="never" class="table-card">
        ...
        <div class="table-header">
          ...
          <div class="table-actions">
            ...
            <el-button
              ...
              >删除</el-button
            >
            <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['doctor:doctorCertificate:export']" size="small"
              >导出</el-button
            >
            <el-button type="primary" plain icon="Upload" @click="handleImport" v-hasPermi="['doctor:doctorCertificate:import']" size="small"
              >导入</el-button
            >
      ...
      <el-table v-loading="loading" border :data="doctorCertificateList" @selection-change="handleSelectionChange" class="doctor-certificate-table">
