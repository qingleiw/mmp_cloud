    ...
    <el-card shadow="hover" class="stats-card mb-4">
      ...
      <el-row :gutter="20" v-loading="loading">
        ...
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="新入" :value="medicalStats.newAdmissions" :value-style="{ color: '#409EFF' }" />
          </div>
        </el-col>
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="在区" :value="medicalStats.inWard" :value-style="{ color: '#67C23A' }" />
          </div>
        </el-col>
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="危重" :value="medicalStats.critical" :value-style="{ color: '#F56C6C' }" />
          </div>
        </el-col>
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="出区" :value="medicalStats.discharged" :value-style="{ color: '#E6A23C' }" />
          </div>
        </el-col>
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="死亡" :value="medicalStats.deaths" :value-style="{ color: '#909399' }" />
          </div>
        </el-col>
        ...
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="转入" :value="medicalStats.transfersIn" :value-style="{ color: '#409EFF' }" />
          </div>
        </el-col>
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="转出" :value="medicalStats.transfersOut" :value-style="{ color: '#67C23A' }" />
          </div>
        </el-col>
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="关注患者" :value="medicalStats.attentionPatients" :value-style="{ color: '#F56C6C' }" />
          </div>
        </el-col>
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="抢救" :value="medicalStats.rescues" :value-style="{ color: '#E6A23C' }" />
          </div>
        </el-col>
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="危急值" :value="medicalStats.criticalValues" :value-style="{ color: '#909399' }" />
          </div>
        </el-col>
        ...
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="病危" :value="medicalStats.criticallyIll" :value-style="{ color: '#F56C6C' }" />
          </div>
        </el-col>
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="病重" :value="medicalStats.seriouslyIll" :value-style="{ color: '#E6A23C' }" />
          </div>
        </el-col>
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="会诊" :value="medicalStats.consultations" :value-style="{ color: '#409EFF' }" />
          </div>
        </el-col>
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="住院超30天" :value="medicalStats.longStayPatients" :value-style="{ color: '#67C23A' }" />
          </div>
        </el-col>
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="三级手术" :value="medicalStats.level3Surgeries" :value-style="{ color: '#F56C6C' }" />
          </div>
        </el-col>
        ...
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="四级手术" :value="medicalStats.level4Surgeries" :value-style="{ color: '#E6A23C' }" />
          </div>
        </el-col>
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="输血" :value="medicalStats.bloodTransfusions" :value-style="{ color: '#909399' }" />
          </div>
        </el-col>
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="入径" :value="medicalStats.pathwayEntries" :value-style="{ color: '#409EFF' }" />
          </div>
        </el-col>
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="抗菌药物" :value="medicalStats.antibioticUsage" :value-style="{ color: '#67C23A' }" />
          </div>
        </el-col>
        <el-col :xs="24" :sm="12" :md="6" :lg="5" :xl="5">
          <div class="stat-card">
            <el-statistic title="二次手术" :value="medicalStats.secondarySurgeries" :value-style="{ color: '#F56C6C' }" />
          </div>
        </el-col>
      </el-row>
    </el-card>
...
<script setup name="MedicalStats" lang="ts">
