    ...
    <el-card shadow="never">
      <template #header>
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate()" v-hasPermi="['ledger:ledgerUnplannedReoperation:edit']">修改</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete()" v-hasPermi="['ledger:ledgerUnplannedReoperation:remove']">删除</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['ledger:ledgerUnplannedReoperation:export']">导出</el-button>
          </el-col>
        ...
        <el-table-column label="操作" align="center" fixed="right"  class-name="small-padding fixed-width">
          <template #default="scope">
            ...
            <el-tooltip content="删除" placement="top">
              <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['ledger:ledgerUnplannedReoperation:remove']"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
...
import { listLedgerUnplannedReoperation, getLedgerUnplannedReoperation, delLedgerUnplannedReoperation, addLedgerUnplannedReoperation, updateLedgerUnplannedReoperation } from '@/api/ledger/ledgerUnplannedReoperation';
...
const data = reactive<PageData<LedgerUnplannedReoperationForm, LedgerUnplannedReoperationQuery>>({
  ...
  rules: {
    ...
    firstOperationDate: [
      { required: true, message: "第一次手术日期不能为空", trigger: "blur" }
    ],
    reoperationDate: [
      { required: true, message: "再次手术日期不能为空", trigger: "blur" }
    ],
  }
});
...
/** 导出按钮操作 */
const handleExport = () => {
  proxy?.download('ledger/ledgerUnplannedReoperation/export', {
    ...queryParams.value
