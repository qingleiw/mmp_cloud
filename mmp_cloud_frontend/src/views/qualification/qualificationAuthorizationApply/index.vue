<template>
  <div class="app-container">
    ...
    <div class="page-header mb-4">
      ...
      <p class="page-description">管理授权申请和审批流程</p>
    </div>
    ...
    <el-card shadow="never" class="table-card">
      <template #header>
        <div class="table-header">
          ...
          <div class="table-actions">
            <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['qualification:qualificationAuthorizationApply:add']" size="small">新增</el-button>
            <el-button
              type="success"
              plain
              icon="Edit"
            ...
            <el-button
              ...
              size="small"
            >删除</el-button>
            <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['qualification:qualificationAuthorizationApply:export']" size="small">导出</el-button>
      ...
      <el-table
        v-loading="loading"
        border
        :data="qualificationAuthorizationApplyList"
        ...
        <el-table-column label="操作" align="center" fixed="right" class-name="small-padding fixed-width" width="120">
          <template #default="scope">
            <el-tooltip content="修改" placement="top">
              <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['qualification:qualificationAuthorizationApply:edit']"></el-button>
            </el-tooltip>
...
import { QualificationAuthorizationApplyVO, QualificationAuthorizationApplyQuery, QualificationAuthorizationApplyForm } from '@/api/qualification/qualificationAuthorizationApply/types';
...
const getList = async () => {
  loading.value = true;
  try {
    const res = await listQualificationAuthorizationApply(queryParams);
...
const submitForm = async () => {
  try {
    ...
    if (form.id) {
      await updateQualificationAuthorizationApply(form);
      proxy?.$modal.msgSuccess('修改成功');
    } else {
      await addQualificationAuthorizationApply(form);
