      ...
      <template #header>
        <div class="mb8 flex items-center gap-2 flex-nowrap">
          ...
          <div class="ml-auto flex items-center gap-2">
            <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['system:qualificationExamRecord:add']">新增</el-button>
            <el-button
              type="success"
              plain
              icon="Edit"
              :disabled="single"
              @click="handleUpdate()"
              v-hasPermi="['system:qualificationExamRecord:edit']"
              >修改</el-button
            >
            <el-button
              type="danger"
              ...
              :disabled="multiple"
              @click="handleDelete()"
              v-hasPermi="['system:qualificationExamRecord:remove']"
              >删除</el-button
            >
            <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['system:qualificationExamRecord:export']"
              >导出</el-button
            >
