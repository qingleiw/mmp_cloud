    ...
    <el-card shadow="never">
      <template #header>
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['system:ledgerUnplannedReoperation:add']">新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
              type="success"
              ...
              :disabled="single"
              @click="handleUpdate()"
              v-hasPermi="['system:ledgerUnplannedReoperation:edit']"
              >修改</el-button
            >
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              :disabled="multiple"
              @click="handleDelete()"
              v-hasPermi="['system:ledgerUnplannedReoperation:remove']"
              >删除</el-button
            >
          </el-col>
          <el-col :span="1.5">
            <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['system:ledgerUnplannedReoperation:export']"
              >导出</el-button
            >
          </el-col>
...
} from '@/api/system/ledgerUnplannedReoperation';
import {
  LedgerUnplannedReoperationVO,
  LedgerUnplannedReoperationQuery,
  LedgerUnplannedReoperationForm
} from '@/api/system/ledgerUnplannedReoperation/types';
