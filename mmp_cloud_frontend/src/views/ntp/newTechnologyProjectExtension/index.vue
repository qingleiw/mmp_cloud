<template>
  <div class="app-container">
    ...
    <div class="page-header mb-4">
      ...
      <p class="page-description">管理新技术项目的延期申请，包括申请编号、延期天数、延期理由等信息</p>
    </div>
    ...
    <el-card shadow="never" class="table-card">
      <template #header>
        <div class="table-header">
          ...
          <div class="table-actions">
            <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['ntp:newTechnologyProjectExtension:add']" size="small"
              >新增</el-button
            >
            <el-button
              type="success"
            ...
            <el-button
              ...
              >删除</el-button
            >
            <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['ntp:newTechnologyProjectExtension:export']" size="small"
              >导出</el-button
            >
      ...
      <el-table v-loading="loading" border :data="newTechnologyProjectExtensionList" @selection-change="handleSelectionChange" class="new-technology-project-extension-table">
        ...
        >
          <template #default="scope">
            <!-- 日期字段格式化 -->
            <span v-if="field.prop === 'originalEndDate' || field.prop === 'newEndDate'">
            ...
            <!-- 申请状态标签 -->
            <el-tag v-else-if="field.prop === 'applyStatus'" :type="getApplyStatusTagType(scope.row[field.prop])">
    ...
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="600px" append-to-body>
      <el-form ref="newTechnologyProjectExtensionFormRef" :model="form" :rules="rules" label-width="100px">
        <el-row :gutter="20">
          <el-col
            v-for="field in fieldConfigManager.getVisibleFields()"
            :key="field.prop"
...
import { createNewTechnologyProjectExtensionFieldConfig } from '@/utils/configs/ntp/ntpFieldConfigs';
import { createNewTechnologyProjectExtensionSearchConfig } from '@/utils/configs/ntp/ntpSearchConfigs';
...
/** 获取申请状态标签类型 */
const getApplyStatusTagType = (applyStatus: string) => {
  ...
  return typeMap[applyStatus] || 'primary';
};
