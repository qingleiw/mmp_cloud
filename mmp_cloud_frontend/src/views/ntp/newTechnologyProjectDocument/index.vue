<template>
  <app-container>
    <page-header title="新技术项目文档管理">
      <template #action>
        <el-button type="primary" icon="Plus" @click="handleAdd" v-hasPermi="['ntp:newTechnologyProjectDocument:add']">新增</el-button>
        <el-button
          type="success"
          plain
          icon="Edit"
        ...
        <el-button
          ...
          >删除</el-button
        >
        <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['ntp:newTechnologyProjectDocument:export']"
          >导出</el-button
        >
      </template>
    </page-header>
    ...
    <table-card v-loading="loading" :data="newTechnologyProjectDocumentList" @selection-change="handleSelectionChange">
      <template #columns>
        <el-table-column type="selection" width="55" align="center" />
        <el-table-column label="主键ID" align="center" prop="id" v-if="false" />
        <el-table-column
          label="文档类型：application-申报书，approval-批复文件，progress-进展报告，final-结题报告"
          align="center"
          prop="documentType"
        />
