<template>
  <app-container>
    <page-header title="新技术项目实施管理">
      <template #action>
        <el-button type="primary" icon="Plus" @click="handleAdd" v-hasPermi="['ntp:newTechnologyProjectImplementation:add']"
          >新增</el-button
        >
        <el-button
          type="success"
        ...
        <el-button
          ...
          >删除</el-button
        >
        <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['ntp:newTechnologyProjectImplementation:export']"
          >导出</el-button
        >
      </template>
    </page-header>
    ...
    <search-card v-model:show="showSearch" @search="handleQuery" @reset="resetQuery">
      <el-form ref="queryFormRef" :model="queryParams" :inline="true">
        ...
        <el-form-item label="实施日期" prop="implementationDate">
          <el-date-picker clearable v-model="queryParams.implementationDate" type="date" value-format="YYYY-MM-DD" placeholder="请选择实施日期" />
        </el-form-item>
    ...
    <table-card v-loading="loading" :data="newTechnologyProjectImplementationList" @selection-change="handleSelectionChange">
      <template #columns>
    ...
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="500px" append-to-body>
      <el-form ref="newTechnologyProjectImplementationFormRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="实施日期" prop="implementationDate">
          <el-date-picker clearable v-model="form.implementationDate" type="datetime" value-format="YYYY-MM-DD HH:mm:ss" placeholder="请选择实施日期">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="实施结果" prop="implementationResult">
