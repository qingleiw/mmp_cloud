<template>
  <div class="app-container">
    ...
    <div class="page-header mb-4">
      ...
      <p class="page-description">管理肿瘤质控问题的整改跟踪</p>
    </div>
      ...
      <template #header>
        <div class="table-header">
          ...
          <div class="table-actions">
            <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['tumorqc:tumorQcRectification:add']" size="small">新增</el-button>
            <el-button
              type="success"
              plain
              icon="Edit"
            ...
            <el-button
              ...
              size="small"
            >删除</el-button>
            <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['tumorqc:tumorQcRectification:export']" size="small">导出</el-button>
...
import { createTumorQcRectificationFieldConfig } from '@/utils/configs/tumorqc/tumorqcFieldConfigs';
import { createTumorQcRectificationSearchConfig } from '@/utils/configs/tumorqc/tumorqcSearchConfigs';
...
const getList = async () => {
  loading.value = true;
  try {
    const res = await listTumorQcRectification(queryParams);
...
const submitForm = async () => {
  try {
    ...
    if (form.id) {
      await updateTumorQcRectification(form);
      proxy?.$modal.msgSuccess('修改成功');
    } else {
      await addTumorQcRectification(form);
