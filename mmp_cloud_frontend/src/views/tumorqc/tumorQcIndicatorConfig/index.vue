...
} from '@/api/system/tumorQcIndicatorConfig';
import { TumorQcIndicatorConfigVO, TumorQcIndicatorConfigQuery, TumorQcIndicatorConfigForm } from '@/api/system/tumorQcIndicatorConfig/types';
