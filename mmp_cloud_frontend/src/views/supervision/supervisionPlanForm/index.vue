    ...
    <el-card shadow="never">
      <template #header>
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['system:supervisionPlanForm:add']">新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate()" v-hasPermi="['system:supervisionPlanForm:edit']"
              >修改</el-button
            >
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              :disabled="multiple"
              @click="handleDelete()"
              v-hasPermi="['system:supervisionPlanForm:remove']"
              >删除</el-button
            >
          </el-col>
          <el-col :span="1.5">
            <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['system:supervisionPlanForm:export']">导出</el-button>
          </el-col>
          ...
          <template #default="scope">
            <el-tooltip content="修改" placement="top">
              <el-button
                ...
                v-hasPermi="['system:supervisionPlanForm:edit']"
              ></el-button>
            </el-tooltip>
...
} from '@/api/system/supervisionPlanForm';
import { SupervisionPlanFormVO, SupervisionPlanFormQuery, SupervisionPlanFormForm } from '@/api/system/supervisionPlanForm/types';
