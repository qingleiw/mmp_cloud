...
项目提供了基于模板的页面自动生成工具，可以快速批量生成 Vue 组件页面。

```bash
# 生成 exam 模块页面
npm exec tsx scripts/generate-exam-pages.ts

# 生成 ledger 模块页面
npm exec tsx scripts/generate-pages-from-template.ts ledger

# 生成 qualification 模块页面
npm exec tsx scripts/generate-pages-from-template.ts qualification
```
...
**详细文档：** 查看 [scripts/README.md](./scripts/README.md) 了解如何使用和自定义页面生成工具。
